...
namespace Azul
{
	...
	StringThis::StringThis(Mesh::Name status)
	{
		switch (status)
		{
			...
			case Mesh::Name::A:
				strcpy_s(this->buffer, BUFFER_SIZE, STRING_ME(Mesh::A));
				break;

			case Mesh::Name::B:
				strcpy_s(this->buffer, BUFFER_SIZE, STRING_ME(Mesh::B));
				break;

			case Mesh::Name::C:
				strcpy_s(this->buffer, BUFFER_SIZE, STRING_ME(Mesh::C));
				break;

			case Mesh::Name::D:
				strcpy_s(this->buffer, BUFFER_SIZE, STRING_ME(Mesh::D));
				break;

			case Mesh::Name::E:
				strcpy_s(this->buffer, BUFFER_SIZE, STRING_ME(Mesh::E));
				break;
